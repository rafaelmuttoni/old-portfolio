...
const Projects = () => {
  ...
  return (
    <S.ContentWrapper>
      ...
      <SingleProject title="Rafael Muttoni - Portfolio" url="https://rafaelmuttoni.com" description="This website's purpose is to serve me as my Resume and Portfolio." tags={['Front-end', 'Javascript', 'HTML5', 'CSS', 'React', 'Gatsby', 'GraphQL', 'styled-components']} dkImg={portfolioDkImg} mbImg={portfolioMbImg}/>
      <SingleProject title="Dynamic's Website" url="https://dynamicpoa.com" description="Website made for a company that offers solutions with Microsft's products (Office, PowerBI, etc.)." tags={['Front-end', 'Javascript', 'HTML5', 'CSS', 'React', 'Gatsby', 'Tailwindcss', 'Lottie']} dkImg={dynamicDkImg} mbImg={dynamicMbImg}/>
      <SingleProject title="Saúde dos Pés" url="http://cirurgiaminimanope.com.br/" description="Website made for a Doctor, it's purpose is to inform about a specific foot surgery." tags={['Front-end', 'Wordpress', 'Elementor', 'Microthemer', 'HTML5', 'CSS']} dkImg={fabioDkImg} mbImg={fabioMbImg}/>
      <SingleProject title="Pokémon Searcher" url="https://pokemonsearcher.netlify.app/" description="A React App fetching data from PokéAPI." tags={['Front-end', 'Javascript', 'HTML5', 'CSS', 'React', 'Axios', 'styled-components']} dkImg={pokemonDkImg} mbImg={pokemonMbImg}/>
      <SingleProject title="Compound Interest Calculator" url="https://juroscompostos.netlify.com/" description="A compound interest calculator for your long term investments." tags={['Front-end', 'Javascript', 'HTML5', 'CSS', 'React', 'Gatsby', 'GraphQL', 'styled-components']} dkImg={compoundDkImg} mbImg={compoundMbImg}/>
    </S.ContentWrapper>
  )
}
